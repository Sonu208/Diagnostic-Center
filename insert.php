...
$sql ="INSERT INTO Booking (First,Last,Email,City,Phone,Query)
VALUES('$_POST[First]','$_POST[Last]','$_POST[Email]','$_POST[City]','$_POST[City]');";
...
<center><img src="blue.gif" height="200px" width="350px"></center>
