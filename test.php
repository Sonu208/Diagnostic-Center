...
<script>
  function validateForm() {
    ...
    let l = document.forms["myForm"]["Specialities"].value;
    if (l == "") {
      alert("You must select any scan");
      return false;
    }
...
<select name="Specialities" size="2" >
...
<br>
 ...
 <br>
<b> Phone no. </b> 
<input type="text" name="Phone" id="Phone" > <!-- onkeydown="myFunction2()" >-->
<br>
<br>
