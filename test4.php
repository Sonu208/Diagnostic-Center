...
<hr>
<b> First name </b>
<input type="text" name="First" id="First" onblur="myFunction1()" required>
<br>
<br>
<b> Last name </b>
<input type="text" name="Last" id="Last" onkeyup="myFunction3()" required>
<br>
<br>
<b> Email address</b>
<input type="text" name="Email" onfocus="myFunction4(this)" required>
<br>
<br>
<b> Gender </b>
...
<br>
 <b> Address</b>
<input type="text" name="Address" id="Address" required> <!-- onkeypress="myFunction()"  > -->
<br>
<br>
